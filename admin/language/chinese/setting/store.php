...
$_['entry_tax']                 = '显示含税价：';
$_['entry_tax_default']         = '使用商店所在地税率：<br /><span class="help">非注册会员使用商店所在地税率。 你可以使用商店所在地税率计算税费。</span>';
$_['entry_tax_customer']        = '使用会员所在地税率：<br /><span class="help">注册会员使用会员所在地税率。 你可以使用商店所在地税率计算税费。</span>';
$_['entry_customer_group']      = '会员等级：<br /><span class="help">默认会员等级。</span>';
$_['entry_customer_group_display'] = '会员等级：<br /><span class="help">显示用户群体，新注册用户时可以选择。</span>';
