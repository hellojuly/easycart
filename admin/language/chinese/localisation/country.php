...
// Help
$_['help_address_format']     = '姓氏 = {firstname}<br />名字 = {lastname}<br />公司 = {company}<br />地址 1 = {address_1}<br />地址 2 = {address_2}<br />城市 = {city}<br />邮编 = {postcode}<br />地区 = {zone}<br />地区代码 = {zone_code}<br />国家 = {country}';
